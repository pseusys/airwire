...
class VkIdOAuth {
  ...
  Uri buildAuthorizeUrl({
    ...
    return Uri.https(_host, '/authorize', {
      ...
      'state': state,
      // PLACEHOLDER — 'email' is not a messaging permission; the actual
      // scope string to request here is still unconfirmed. See TODO.md's
      // "VK ID app registration" item -- a graph/me/messages call failing
